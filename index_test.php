...
$selectGerechtArray = $gerecht-> selecteerGerecht();     // voer hier het gerecht_id in
...
// Vraag 16 zoekfunctie
//$testZoekfunctie = $zoekfunctie->zoekfunctie("komkommer");
//var_dump($testZoekfunctie);
